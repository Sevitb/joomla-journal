...
$wa->registerAndUseScript('script.selectField', 'media/layouts/js/journal/form/field/ajaxAuthorSearch.js');
...
?>
<select class="form-select js-author-data" style="width:100%;" name="<?php echo $name ?>" <?php echo trim($attr) ?> multiple>
    <?php if ($value) : ?>
