        ...
        <div class="row ">
            <div class="col-12 col-lg-8">
                <div class="content-section__main-column default-block">
                    ...
                    <form action="<?php echo Route::_('index.php?option=com_jcontent&view=pass&layout=edit&id=' . $articleId); ?>" method="POST" name="adminForm" id="adminForm" class="form-validate form-vertical" enctype="multipart/form-data">
                        ...
                        <?php echo $this->form->renderField('editor_comment'); ?>
                        <input type="submit" class="btn mt-3" value="Отправить" onclick="Joomla.submitbutton('pass.save')">
