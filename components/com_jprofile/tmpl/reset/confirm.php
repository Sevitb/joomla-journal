...
<section class="content-section">
    <div class="container">
        <div class="content-section__main-column default-block justify-content-center row">
            <form action="<?php echo Route::_('index.php?option=com_jprofile&task=reset.confirm'); ?>" method="post" class="com-users-reset-confirm__form form-validate col-12 col-lg-9 form-horizontal well">
