...
class ResetController extends BaseController
{
    ...
    public function request()
    {
        ...
        if ($return instanceof \Exception && JDEBUG) {
            ...
            $this->setRedirect(Route::_('index.php?option=com_jprofile&view=reset'), $message, 'error');
            ...
            $this->setRedirect(Route::_('index.php?option=com_jprofile&view=reset'), $message, 'notice');
        ...
        $this->setRedirect(Route::_('index.php?option=com_jprofile&view=reset&layout=confirm', false), $message, 'notice');
    ...
    public function confirm()
    {
        ...
        if ($return instanceof \Exception) {
            ...
            $this->setRedirect(Route::_('index.php?option=com_jprofile&view=reset&layout=confirm', false), $message, 'error');
            ...
            $this->setRedirect(Route::_('index.php?option=com_jprofile&view=reset&layout=complete', false));
    ...
    public function complete()
    {
        ...
        if ($return instanceof \Exception) {
            ...
            $this->setRedirect(Route::_('index.php?option=com_jprofile&view=reset&layout=complete', false), $message, 'error');
            ...
            $this->setRedirect(Route::_('index.php?option=com_jprofile&view=reset&layout=complete', false), $message, 'notice');
            ...
            $this->setRedirect(Route::_('index.php?option=com_jprofile&view=profile', false), $message);
