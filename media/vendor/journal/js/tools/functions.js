...
// nodeArray - elements to which the class will be removed;
...
function removeClassOnScroll(className, nodesArray) {
...
export { removeLoader, getFormData, addClassOnClick, removeClassOnClick, clickOutside, removeClassOnScroll };